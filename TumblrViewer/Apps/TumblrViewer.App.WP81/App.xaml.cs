...
namespace TumblrViewer.App.WP81
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            var navigationService = InstanceFactory.GetInstance<Tumblr.Contracts.Services.INavigationService>();
            ...
            if (rootFrame.Content == null)
            {
                ...
                navigationService.Navigate(InstanceFactory.GetInstanceType<ILoginView>());
            }
